...
function setLanguage(language) {
    if (language === 'pt') {
        ...
        if (window.location.pathname.endsWith('cvptbr.html') || window.location.pathname.endsWith('cv.html')) {
            window.location.href = 'cv.html';
        } else if (window.location.pathname.endsWith('indexptbr.html') || window.location.pathname.endsWith('index.html')) {
